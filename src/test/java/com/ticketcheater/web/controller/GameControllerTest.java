...
class GameControllerTest {
    ...
    @Test
    @WithMockUser
    void givenAdminUserWithGame_whenSaving_thenSavesGame() throws Exception {
    ...
    @DisplayName("로그인하지 않은 유저가 게임을 생성할 경우 에러를 내뱉는다.")
    @Test
    @WithAnonymousUser
    void givenUnauthorizedUserWithGame_whenSaving_thenThrowsError() throws Exception {
    ...
    @DisplayName("관리자가 아닌 유저가 게임을 생성할 경우 에러를 내뱉는다.")
    @Test
    @WithMockUser
    void givenNotAdminUserWithGame_whenSaving_thenThrowsError() throws Exception {
    ...
    @Test
    @WithMockUser
    void givenInvalidCategory_whenSaving_thenThrowsError() throws Exception {
    ...
    @Test
    @WithMockUser
    void givenDefaultPage_whenSearching_thenReturnsGames() throws Exception {
    ...
    @Test
    @WithMockUser
    void givenDefaultPageWithValidCategory_whenSearchingWithCategory_thenReturnsGames() throws Exception {
    ...
    @Test
    @WithMockUser
    void givenDefaultPageWithInValidCategory_whenSearchingWithCategory_thenThrowsError() throws Exception {
    ...
    @DisplayName("로그인 하지 않은 유저가 게임을 조회할 경우 오류를 내뱉는다")
    @Test
    @WithMockUser
    ...
    @Test
    @WithMockUser
    void givenAdminUserWithGame_whenUpdating_thenUpdatesGame() throws Exception {
    ...
    @Test
    @WithMockUser
    void givenNotAdminUserWithGame_whenUpdating_thenThrowsError() throws Exception {
